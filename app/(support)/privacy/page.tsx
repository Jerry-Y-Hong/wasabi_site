        ...
        <Container size="md" py={80}>
            <Paper p="xl" withBorder radius="md" shadow="sm">
                ...
                <Paper withBorder p="md" bg="gray.0">
                    <Text fw={700}>농업회사법인 주식회사 케이팜그룹 (K-Farm Group)</Text>
                    <Text>이메일: sbienv0633@gmail.com</Text>
                    <Text>Phone: +82 10-4355-0633</Text>
                    <Text>Address: 강원특별자치도 철원군 근남면 초막동길 2-1</Text>
                </Paper>
            </Paper>
        </Container>
    );
