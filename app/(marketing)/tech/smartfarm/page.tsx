                                            ...
                                            <ListItem key={item.file}>
                                                <Group gap="xs" wrap="nowrap">
                                                    <Anchor
                                                        ...
                                                        {...(docId ? { href: `/tech/smartfarm/docs/${docId}` } : { href: `/tech/smartfarm/docs/${item.file}`, target: "_blank", rel: "noopener" })}
                                                        fw={docId ? 700 : 400}
                                                        c={docId ? 'teal' : 'dimmed'}
                                                    >
                                                        {displayTitle}
                        ...
                        <Grid.Col span={{ base: 12, md: 6 }}>
                            <Stack gap="md" h="100%">
                                ...
                                <Card shadow="sm" padding="lg" radius="md" withBorder>
                                    <Link href="/tech/smartfarm/rda-api" style={{ textDecoration: 'none', color: 'inherit' }}>
                                        <Group>
                                ...
                                {/* Hardware */}
                                <Card shadow="sm" padding="lg" radius="md" withBorder>
                                    <Link href="/tech/smartfarm/hardware" style={{ textDecoration: 'none', color: 'inherit' }}>
                                        <Group>
                                ...
                                {/* Roadmap */}
                                <Card shadow="sm" padding="lg" radius="md" withBorder>
                                    <Link href="/tech/smartfarm/roadmap" style={{ textDecoration: 'none', color: 'inherit' }}>
                                        <Group>
