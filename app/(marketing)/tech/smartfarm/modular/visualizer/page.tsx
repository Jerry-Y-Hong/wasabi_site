        ...
        <Container size="xl" py={60}>
            <Group justify="space-between" mb={40}>
                <Button
                    ...
                    component={Link}
                    href="/tech/smartfarm/modular/assembly"
                >
                    {t('vis_back')}
                </Button>
                <Badge size="xl" variant="outline" color="wasabi.6">{t('vis_badge')}</Badge>
            </Group>
            ...
            <Grid gutter={80}>
                ...
                <Grid.Col span={{ base: 12, md: 5 }}>
                    <Stack gap="xl">
                        <Box>
                            <Title order={1} mb="xs">{t('vis_title_main')} <span style={{ color: 'var(--mantine-color-wasabi-6)' }}>{t('vis_title_highlight')}</span></Title>
                            ...
                            <Stack gap="lg">
                                <Box>
                                    <Group justify="space-between" mb="sm">
                                        <Text fw={700}>{t('vis_label_stack').replace('{count}', moduleCount.toString())}</Text>
                                        <Group gap="xs">
                                ...
                                <Box>
                                    <Group justify="space-between" mb="sm">
                                        <Text fw={700}>{t('vis_label_column').replace('{count}', columnCount.toString())}</Text>
                                        <Group gap="xs">
                                ...
                                <Box>
                                    <Text fw={700} mb="sm">{t('vis_label_maint')}</Text>
                                    <Button
                                        fullWidth
                                        size="lg"
                                    ...
                                    >
                                        {doorOpen ? t('vis_btn_door_close') : t('vis_btn_door_open')}
                                    </Button>
                                </Box>
                            </Stack>
                        </Paper>
                ...
                <Grid gutter={40}>
                    <Grid.Col span={{ base: 12, md: 4 }}>
                        <Stack align="center" gap="sm">
                            ...
                            <Text fw={700} size="lg">{t('vis_phil1_title')}</Text>
                            <Text ta="center" c="dimmed">{t('vis_phil1_desc')}</Text>
                        </Stack>
                    </Grid.Col>
                    <Grid.Col span={{ base: 12, md: 4 }}>
                        <Stack align="center" gap="sm">
                            <ThemeIcon size={40} radius="md" color="wasabi.6"><IconBolt /></ThemeIcon>
                            <Text fw={700} size="lg">{t('vis_phil2_title')}</Text>
                            <Text ta="center" c="dimmed">{t('vis_phil2_desc')}</Text>
                        </Stack>
                    </Grid.Col>
                    <Grid.Col span={{ base: 12, md: 4 }}>
                        <Stack align="center" gap="sm">
                            <ThemeIcon size={40} radius="md" color="wasabi.6"><IconDroplet /></ThemeIcon>
                            <Text fw={700} size="lg">{t('vis_phil3_title')}</Text>
                            <Text ta="center" c="dimmed">{t('vis_phil3_desc')}</Text>
                        </Stack>
                    </Grid.Col>
                </Grid>
            </Box>
