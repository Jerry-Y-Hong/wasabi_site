...
export default async function InsightsPage() {
    ...
    return (
        <Container size="xl" py={80}>
            ...
            {/* Comparison Section (Manual Grid) */}
            <div style={{
                display: 'grid',
            ...
            {/* Global Crisis Section (Manual Grid) */}
            <div style={{
                display: 'grid',
                    ...
                    <Stack gap="lg">
                        ...
                        <Group align="flex-start">
                            ...
                            <Box flex={1}>
                                ...
                                <Text c="dimmed">The average age of farmers is rising, leading to farm closures.</Text>
                            </Box>
                        </Group>
                        <Group align="flex-start">
                            ...
                            <Box flex={1}>
                                ...
                                <Text c="dimmed">The global expansion of Japanese cuisine has created a 300% demand surge.</Text>
                            </Box>
                        </Group>
                    </Stack>
                </Box>
            ...
            <Box py={60} style={{ borderTop: '1px solid var(--mantine-color-gray-2)' }}>
                ...
                <div style={{
                    ...
                    <Paper p="md" radius="md" withBorder>
                        ...
                        <Text size="sm">Integrating Regional Revitalization, Franchise Bakery Cafes, and Pharma Raw Materials.</Text>
                    </Paper>
                    <Paper p="md" radius="md" withBorder>
                        <Title order={4} mb="xs">Social Impact & Welfare</Title>
                        <Text size="sm">Creating sustainable jobs through social enterprise models for regional balance.</Text>
                    </Paper>
                    <Paper p="md" radius="md" withBorder>
                        <Title order={4} mb="xs">Wasabi Kimchi & Global Cuisine</Title>
                        <Text size="sm">Pioneering new food categories like premium Wasabi Kimchi for the global market.</Text>
                    </Paper>
                </div>
            </Box>

            {/* Latest News Section (Manual Grid) */}
            <Box py={60} style={{ borderTop: '1px solid var(--mantine-color-gray-2)' }}>
